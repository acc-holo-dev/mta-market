...
| WHEN | (а) автоматически перед каждым production deploy; (б) по расписанию — nightly cron: `0 4 * * * cd /srv/mta-market-site && ./scripts/backup.sh >> backups/cron.log 2>&1` |
...
docker run --rm -v mta-market-site_uploads_data:/dst \
